...
from keras.layers import Dense, Dropout, Activation, Convolution2D, MaxPooling2D, Flatten, BatchNormalization
...
#    data_dim = 160*256
    ...
    model.add(Convolution2D(12, 15, 15, border_mode='same', input_shape=(1, 160, 256)))
...
#    model.add(Dropout(0.2))
    ...
    for i in range(len(x_test)):
        ...
        image = np.reshape(test_case[0, ...], (160,256))
        plt.imshow(image.T)
        plt.show()
