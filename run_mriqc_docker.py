...
if __name__ == '__main__':
    ...
    for filename in os.listdir(bids_dir):
        ...
        return_code = subprocess.run(['docker', 'run', '-it', '--rm', '-v', '/data1/users/adoyle/IBIS/BIDS/:/data:ro', '-v', '/data1/users/adoyle/IBIS/mriqc_output/:/out poldracklab/mriqc:latest', '/data', '/out', 'participant', '--participant_label', subj_id, '--no-sub'], check=True)
