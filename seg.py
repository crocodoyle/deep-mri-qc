...
def segmentation_model():
    ...
    conv2 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(pool1)
    conv2 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(conv2)
    pool2 = MaxPooling3D(pool_size=(2,2,2))(conv2)

    conv3 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(pool2)
    conv3 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(conv3)
    pool3 = MaxPooling3D(pool_size=(2,2,2))(conv3)

    conv4 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(pool3)
    conv4 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(conv4)
    pool4 = MaxPooling3D(pool_size=(2,2,2))(conv4)

    conv5 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(pool4)
    conv5 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(conv5)
    pool5 = MaxPooling3D(pool_size=(2,2,2))(conv5)

    conv6 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(pool5)
    conv6 = Convolution3D(16, 4, 4, 4, activation='relu', border_mode='same')(conv6)
    pool6 = MaxPooling3D(pool_size=(2,2,2))(conv6)

    conv7 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(pool6)
    conv7 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(conv7)

    up8 = merge([UpSampling3D(size=(2,2,2))(conv7), conv6], mode='concat', concat_axis=1)
    conv8 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(up8)
    conv8 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(conv8)

    up9 = merge([UpSampling3D(size=(2,2,2))(conv8), conv5], mode='concat', concat_axis=1)
    ...
    up10 = merge([UpSampling3D(size=(2,2,2))(conv9), conv4], mode='concat', concat_axis=1)
    conv10 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(up10)
    conv10 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(conv10)

    up11 = merge([UpSampling3D(size=(2,2,2))(conv10), conv3], mode='concat', concat_axis=1)
    conv11 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(up11)
    conv11 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(conv11)

    up12 = merge([UpSampling3D(size=(2,2,2))(conv11), conv2], mode='concat', concat_axis=1)
    conv12 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(up12)
    conv12 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(conv12)

    up13 = merge([UpSampling3D(size=(2,3,2))(conv12), conv1], mode='concat', concat_axis=1)
    conv13 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(up13)
    conv13 = Convolution3D(16, 3, 4, 3, activation='relu', border_mode='same')(conv13)

    conv14 = Convolution3D(13, 1, 1, 1, activation='sigmoid')(conv13)
